...
class UserController extends Controller
{
    ...
    public function userList() {
        ...
        foreach ($res as $row) {
            ...
            $operate = '<a  id="' . $row->id . '" data-permission="'.$permission.'"  data-status='.$row->status.' data-bs-toggle="modal" data-bs-target="#editUsereditModal"  onclick="setValue(this.id);" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;';
            $operate .= '<a  id="'.$row->id.'" data-bs-toggle="modal"  data-bs-target="#resetpasswordmodel" onclick="setpasswordValue(this.id);"><i class="bi bi-key text-dark-50"></i></a>';
