...
class ArticleController extends Controller
{
    ...
    public function show()
    {
        ...
        foreach ($res as $row) {
            ...
            $tempRow['image'] = ($row->image != '') ? '<a class="image-popup-no-margins" href="' . url('images') . config('global.ARTICLE_IMG_PATH')  . $row->image . '"><img class="rounded avatar-md shadow img-fluid" alt="" src="' . url('images') . config('global.ARTICLE_IMG_PATH')  . $row->image . '" width="55"></a>' : '';
    ...
    public function edit($id)
    {
        ...
        return view('article.edit', compact('list', 'id'));
    }
