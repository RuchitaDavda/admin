                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                {{ Form::label('measurement', 'Measurement', ['class' => 'col-sm-4 col-form-label text-center']) }}
                                <div class="col-sm-4">
                            ...
                            <div class="col-sm-12">
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory">
                                        <label for="edit_measurement"
                                            class="form-label col-12 text-center">Measurement</label>
