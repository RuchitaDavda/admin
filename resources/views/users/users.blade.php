...
@section('content')
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table-light" aria-describedby="mydesc" class='table-striped' id="table_list" data-toggle="table"
                            data-url="{{url('userList')}}"  data-click-to-select="true" data-side-pagination="server" data-pagination="true"
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group mandatory align-items-center">
                                        <label for="password" class="form-label col-12 text-center">Password</label>
    ...
    <div id="editUsereditModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
      aria-hidden="true">
      <div class="modal-dialog modal-fullscreen">
          <div class="modal-content">
              <div class="modal-header">
                      ...
                      <div class="row">
                          <div class="col-sm-4">
                              ...
                              <div class="col-md-12 col-12">
                                  <div class="form-group mandatory">
                                      <label for="name" class="form-label col-12 text-center">Name</label>
                                      <input type="text" id="edit_name" class="form-control col-12" placeholder="Name"
                                          name="name" data-parsley-required="true">
                                  </div>
                              </div>
                              ...
                              <div class="col-md-12 col-12">
                                  <div class="form-group mandatory">
                                      <label for="email" class="form-label col-12 text-center">Email</label>
                                      <input type="email" id="edit_email" class="form-control col-12" placeholder="email"
                                          name="email" data-parsley-required="true">
                                  </div>
                              </div>
  ...
  <!-- EDIT USER MODEL -->
      ...
      <div id="resetpasswordmodel" class="modal fade" tabindex="-1" role="dialog"
     ...
     <div class="modal-dialog modal-lg">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 ...
                 <form action="{{ url('users-reset-password') }}" class="form-horizontal" role="form" method="post">
                     @csrf
                     <div class="row">
                         <div class="form-group row align-items-center">
                             <label for="firstName" class="col-lg-4 col-sm-12 control-label text-center mb-3">New Password</label>
                             <div class="col-lg-8 mb-3">
                                 <input type="password" class="form-control" name="newPassword" id="newPassword" placeholder="New password" minlength="4"  required>
                                 <input type="hidden"  name='pass_id' id="pass_id" required>
                                 <span class="form-text text-muted"><small>Min Password Length Must Be of 4</small></span>
                             </div>
                         </div>
                         <div class="form-group row align-items-center">
                             <label for="firstName" class="col-lg-4 col-sm-12 control-label text-center">Confirm Password</label>
                             <div class="col-lg-8 mb-3">
                                 <input type="password" class="form-control" name="confPassword" id="confPassword"  placeholder="Confirm password" minlength="4"  required>
                                 <span class="form-text text-muted"><small>Min Password Length Must Be of 4</small></span>
