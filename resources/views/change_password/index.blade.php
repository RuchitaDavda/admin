                            ...
                            <div class="card-body">
                               ...
                               @if (Auth::user()->type == 0)
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label text-alert text-center">Name</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="email" class="form-control form-control-lg form-control-solid mb-2"
                               ...
                               @endif
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label text-alert text-center">Current
                                        Password</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label text-alert text-center">New Password</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label text-alert text-center">Verify
                                        Password</label>
                                    <div class="col-sm-4">
                                    ...
                                    <span class="error col-sm-4" style="color:red"></span>
                                </div>
                                <div class="form-group row">
